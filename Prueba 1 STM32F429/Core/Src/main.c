...
/**
  ...
  * All rights reserved.
  *
  * PROGRAMA PARA EL ENCENDIDO DE LOS LEDS EN PG13 Y PG14
  * LOS LED SE ENCIENDEN EN SECUENCIAS DE 200ms
  * LOS DOS LED NO ENCIENDEN AL MISMO TIEMPO
  *
  *
  ******************************************************************************
  */
...
/* USER CODE BEGIN PV */
	uint16_t Leds[] = {LD3_Pin, LD4_Pin}; //Arreglo de LEDs se usaron los valores en hexa
...
void HAL_GPIO_EXTI_Callback(uint16_t GPIO_Pin)
{
	...
	//cambiamos la poscicion (la aumentamos o volvemos a la primera
